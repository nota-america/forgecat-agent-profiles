...
## NetsPresso SDK Palette (Project-Specific)

| Module | Background | Stroke | Path |
|--------|------------|--------|------|
| CLI | `#a5d8ff` | `#1971c2` | `src/cli/` |
| Composer | `#d0bfff` | `#7048e8` | `src/composer/` |
| ScenarioManager | `#ffec99` | `#f08c00` | `src/scenario_manager/` |
| ResultManager | `#b2f2bb` | `#2f9e44` | `src/result_manager/` |
| Validator | `#ffd8a8` | `#e8590c` | `src/validator/` |
| DataGenerator | `#99e9f2` | `#0c8599` | `src/data_generator/` |
| Extractor | `#e599f7` | `#9c36b5` | `src/extractor/` |
| Config | `#dee2e6` | `#495057` | `src/config/` |
| Backend (future) | `#d0bfff` | `#7048e8` | - |
| Frontend (future) | `#a5d8ff` | `#1971c2` | - |

### External Systems

| System | Background | Stroke | Shape |
|--------|------------|--------|-------|
...
| SDK Pipeline | Vertical flow | User -> CLI -> Validator -> Composer -> ResultManager |
