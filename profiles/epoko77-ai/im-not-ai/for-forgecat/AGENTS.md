...
- Pass the quick rules and diagnosis rules from `{{ref:humanizeRuntime}}/.claude/skills/humanize-korean/references/` to the runtime agents.
...
The bundled source documentation is available at `{{ref:sourceDocs}}` for provenance and upstream installation details. It does not override these ForgeCat installation paths.
