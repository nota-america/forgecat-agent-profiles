...
For the at-a-glance version of this list, including the pre-launch instrumentation gate, see `.forgecat/profiles/@forgecat/addyosmani_agent-skills/references/observability-checklist.md`.
