...
- For the project-wide Definition of Done that every change must clear before this checklist, see `.forgecat/profiles/@forgecat/addyosmani_agent-skills/references/definition-of-done.md`
- For security pre-launch checks, see `.forgecat/profiles/@forgecat/addyosmani_agent-skills/references/security-checklist.md`
- For performance pre-launch checklist, see `.forgecat/profiles/@forgecat/addyosmani_agent-skills/references/performance-checklist.md`
- For accessibility verification before launch, see `.forgecat/profiles/@forgecat/addyosmani_agent-skills/references/accessibility-checklist.md`
