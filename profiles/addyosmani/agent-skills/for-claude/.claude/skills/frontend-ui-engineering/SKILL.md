...
For detailed accessibility requirements and testing tools, see `.forgecat/profiles/@forgecat/addyosmani_agent-skills/references/accessibility-checklist.md`.
