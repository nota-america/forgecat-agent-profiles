...
These are prevention patterns, not a ranking. For the 2021 ordering, see the quick-reference table in `.forgecat/profiles/@forgecat/addyosmani_agent-skills/references/security-checklist.md`.
...
For detailed security checklists and pre-commit verification steps, see `.forgecat/profiles/@forgecat/addyosmani_agent-skills/references/security-checklist.md`.
