...
- For detailed security review guidance, see `.forgecat/profiles/@forgecat/addyosmani_agent-skills/references/security-checklist.md`
- For performance review checks, see `.forgecat/profiles/@forgecat/addyosmani_agent-skills/references/performance-checklist.md`
