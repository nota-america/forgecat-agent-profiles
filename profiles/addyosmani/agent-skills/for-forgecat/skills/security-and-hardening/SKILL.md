...
These are prevention patterns, not a ranking. For the 2021 ordering, see the quick-reference table in `{{ref:security-checklist}}`.
...
For detailed security checklists and pre-commit verification steps, see `{{ref:security-checklist}}`.
