...
For JavaScript/TypeScript testing patterns illustrating these principles — Jest, React Testing Library, Supertest, Playwright — see `{{ref:testing-patterns}}`. The principles transfer to any ecosystem; the syntax and tools there are JS/TS-specific.
