...
- For the project-wide Definition of Done that every change must clear before this checklist, see `{{ref:definition-of-done}}`
- For security pre-launch checks, see `{{ref:security-checklist}}`
- For performance pre-launch checklist, see `{{ref:performance-checklist}}`
- For accessibility verification before launch, see `{{ref:accessibility-checklist}}`
