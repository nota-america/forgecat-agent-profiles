...
# Contains Studio Marketing Agents
...
```bash
npx forgecat install @forgecat/contains-studio_agents_marketing
```
...
| `twitter-engager` | The Twitter Engager specializes in real-time social media engagement, trending topic leverage, and viral tweet creation. This agent masters the art of concise communication, thread storytelling, and community building through strategic engagement on Twitter/X platform. |
...
| Original repository | https://github.com/contains-studio/agents/tree/main/marketing |
| Version | `0.0.0` |
