...
# Azure Skills — Azure Observability
...
```bash
npx forgecat install @forgecat/microsoft-azure_skills-azure-observability
```
...
> Mapping note: ranking label `azure-observability` is sourced from skill folder `azure-diagnostics` in the upstream repository.
