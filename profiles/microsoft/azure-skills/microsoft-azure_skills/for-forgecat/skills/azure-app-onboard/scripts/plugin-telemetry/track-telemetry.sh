...
SKILLS_DIR="${AZURE_SKILLS_PLUGIN_ROOT_SKILLS_DIR:-$(cd "$SCRIPT_DIR/../.." 2>/dev/null && pwd)/skills}"
...
get_plugin_version() {
    ...
    pluginManifestPath="${AZURE_SKILLS_PLUGIN_ROOT_MANIFEST:-$(dirname "$SKILLS_DIR")/.plugin/plugin.json}"
