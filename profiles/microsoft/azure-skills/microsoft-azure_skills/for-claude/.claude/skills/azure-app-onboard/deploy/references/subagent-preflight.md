...
- ⛔ Do NOT read `deploy-schemas.ts.txt` or `error-classification.md` — main agent reads those on-demand.
...
# ⚠️ If compaction recently occurred: re-read deploy/phase.md Steps 6-8
```
