...
> ⛔ **Before executing the FIRST command of any new phase, re-read that phase's sub-SKILL.md.** After prereq → read `prepare/phase.md`. After prepare → `scaffold/phase.md`. After scaffold gate → `deploy/phase.md`. This applies at EVERY transition.
