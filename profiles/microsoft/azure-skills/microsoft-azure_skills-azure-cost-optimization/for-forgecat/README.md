...
```bash
npx forgecat install @forgecat/microsoft-azure_skills-azure-cost-optimization
```
...
> Mapping note: ranking label `azure-cost-optimization` is sourced from skill folder `azure-cost` in the upstream repository.
