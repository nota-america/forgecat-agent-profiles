...
description: >
  ...
  description", or wants to ensure skill follows best practices. Trigger
  proactively after skill creation. Examples:
  ...
  Skill created, proactively trigger skill-reviewer to ensure it follows best
  practices.
