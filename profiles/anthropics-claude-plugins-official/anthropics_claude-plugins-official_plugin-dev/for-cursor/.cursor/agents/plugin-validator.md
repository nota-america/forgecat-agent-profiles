...
description: >
  ...
  structure", "verify plugin is correct", "validate plugin.json", "check plugin
  files", or mentions plugin validation. Also trigger proactively after user
  creates or modifies plugin components. Examples:
  ...
  assistant: "I'll use the plugin-validator agent to perform comprehensive
  validation."
