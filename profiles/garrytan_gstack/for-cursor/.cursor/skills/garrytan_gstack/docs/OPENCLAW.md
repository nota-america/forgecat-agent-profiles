...
The complete ready-to-paste section lives in `$GSTACK_ROOT/openclaw/agents-gstack-section.md`.
...
`$GSTACK_ROOT/openclaw/gstack-lite-CLAUDE.md` — ~15 lines of planning discipline:
...
`$GSTACK_ROOT/openclaw/gstack-full-CLAUDE.md` — chains existing gstack skills:
...
`$GSTACK_ROOT/openclaw/gstack-plan-CLAUDE.md` — full review gauntlet, no implementation:
