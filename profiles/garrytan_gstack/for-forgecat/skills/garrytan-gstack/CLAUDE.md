...
no middle mode). See `.claude/skills/garrytan-gstack/docs/designs/PLAN_TUNING_V1.md` for the full design
...
read `.claude/skills/garrytan-gstack/docs/designs/SIDEBAR_MESSAGE_FLOW.md`. The sidebar has one primary
...
Native OpenClaw skills live in `openclaw/skills/garrytan-gstack-openclaw-*/SKILL.md`. These are
...
```bash
clawhub publish openclaw/skills/garrytan-gstack-openclaw-office-hours \
