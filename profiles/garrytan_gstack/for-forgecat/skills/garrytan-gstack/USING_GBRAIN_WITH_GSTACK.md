...
# Or directly:
~/.claude/skills/garrytan-gstack/bin/gstack-gbrain-repo-policy set "github.com/foo/bar" read-only
```

**To see every policy:**

```bash
~/.claude/skills/garrytan-gstack/bin/gstack-gbrain-repo-policy list
```
