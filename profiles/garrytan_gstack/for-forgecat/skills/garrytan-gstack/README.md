...
# 3. Remove gstack
rm -rf ~/.claude/skills/garrytan-gstack

# 4. Remove global state
rm -rf ~/.gstack

# 5. Remove integrations (skip any you never installed)
rm -rf ~/.codex/skills/garrytan-gstack* 2>/dev/null
rm -rf ~/.factory/skills/garrytan-gstack* 2>/dev/null
rm -rf ~/.kiro/skills/garrytan-gstack* 2>/dev/null
rm -rf ~/.openclaw/skills/garrytan-gstack* 2>/dev/null

# 6. Remove temp files
rm -f /tmp/gstack-* 2>/dev/null

# 7. Per-project cleanup (run from each project root)
rm -rf .gstack .gstack-worktrees .claude/skills/garrytan-gstack 2>/dev/null
rm -rf .agents/skills/garrytan-gstack* .factory/skills/garrytan-gstack* 2>/dev/null
```
