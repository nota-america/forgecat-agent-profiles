...
The complete ready-to-paste section lives in `.claude/skills/garrytan-gstack/openclaw/agents-gstack-section.md`.
...
`.claude/skills/garrytan-gstack/openclaw/gstack-lite-CLAUDE.md` — ~15 lines of planning discipline:
...
`.claude/skills/garrytan-gstack/openclaw/gstack-full-CLAUDE.md` — chains existing gstack skills:
...
`.claude/skills/garrytan-gstack/openclaw/gstack-plan-CLAUDE.md` — full review gauntlet, no implementation:
