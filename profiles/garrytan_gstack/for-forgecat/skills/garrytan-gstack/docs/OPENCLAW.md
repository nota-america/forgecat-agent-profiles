...
The complete ready-to-paste section lives in `$GSTACK_DIR/openclaw/agents-gstack-section.md`.
...
`$GSTACK_DIR/openclaw/gstack-lite-CLAUDE.md` — ~15 lines of planning discipline:
...
`$GSTACK_DIR/openclaw/gstack-full-CLAUDE.md` — chains existing gstack skills:
...
`$GSTACK_DIR/openclaw/gstack-plan-CLAUDE.md` — full review gauntlet, no implementation:
