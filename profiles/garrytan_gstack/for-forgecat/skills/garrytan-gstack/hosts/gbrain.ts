...
const gbrain: HostConfig = {
  ...
  globalRoot: '.gbrain/skills/garrytan-gstack',
  localSkillRoot: '.gbrain/skills/garrytan-gstack',
  hostSubdir: '.gbrain',
  usesEnvVars: true,
  ...
  pathRewrites: [
    { from: '~/.claude/skills/garrytan-gstack', to: '~/.gbrain/skills/garrytan-gstack' },
    { from: '.claude/skills/garrytan-gstack', to: '.gbrain/skills/garrytan-gstack' },
