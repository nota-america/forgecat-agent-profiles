...
const opencode: HostConfig = {
  ...
  globalRoot: '.config/opencode/skills/garrytan-gstack',
  localSkillRoot: '.opencode/skills/garrytan-gstack',
  hostSubdir: '.opencode',
  usesEnvVars: true,
  ...
  pathRewrites: [
    { from: '$GSTACK_DIR', to: '~/.config/opencode/skills/garrytan-gstack' },
    { from: '$GSTACK_DIR', to: '.opencode/skills/garrytan-gstack' },
