...
const codex: HostConfig = {
  ...
  globalRoot: '.codex/skills/garrytan-gstack',
  localSkillRoot: '.agents/skills/garrytan-gstack',
  hostSubdir: '.agents',
  usesEnvVars: true,
  ...
  pathRewrites: [
    { from: '$GSTACK_DIR', to: '$GSTACK_DIR' },
    { from: '$GSTACK_DIR', to: '.agents/skills/garrytan-gstack' },
    { from: '.claude/skills/review', to: '.agents/skills/garrytan-gstack/review' },
  ...
  sidecar: {
    path: '.agents/skills/garrytan-gstack',
