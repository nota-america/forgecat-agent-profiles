...
$GSTACK_DIR/bin/gstack-timeline-log '{"skill":"benchmark-models","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
```bash
BIN="$GSTACK_DIR/bin/gstack-model-benchmark"
[ -x "$BIN" ] || BIN="$GSTACK_DIR/bin/gstack-model-benchmark"
