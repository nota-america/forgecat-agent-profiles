...
~/.claude/skills/garrytan-gstack/bin/gstack-timeline-log '{"skill":"benchmark-models","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
```bash
BIN="$HOME/.claude/skills/garrytan-gstack/bin/gstack-model-benchmark"
[ -x "$BIN" ] || BIN=".claude/skills/garrytan-gstack/bin/gstack-model-benchmark"
