...
~/.claude/skills/garrytan-gstack/bin/gstack-timeline-log '{"skill":"gstack","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
`$B` is the browse binary (resolved from `$_ROOT/.claude/skills/garrytan-gstack/browse/dist/browse` or `~/.claude/skills/garrytan-gstack/browse/dist/browse`).
