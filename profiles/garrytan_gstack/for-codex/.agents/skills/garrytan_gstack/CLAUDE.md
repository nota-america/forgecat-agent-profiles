...
Native OpenClaw skills live in `openclaw/skills/garrytan_gstack-openclaw-*/SKILL.md`. These are
...
```bash
clawhub publish openclaw/skills/garrytan_gstack-openclaw-office-hours \
