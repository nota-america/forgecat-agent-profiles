...
- Linux/macOS: `curl -fsSL https://raw.githubusercontent.com/render-oss/cli/main/bin/install.sh -o render-install.sh && less render-install.sh && sh render-install.sh`
