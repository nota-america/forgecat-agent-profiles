...
description: Review the week using accumulated session evidence — retrieval
  rates, hint depths, calibration accuracy, transfer and unassisted results. The
  learner identifies patterns and sets a strategy goal. Use weekly or after a
  multi-session period.
disable-model-invocation: false
user-invocable: true
effort: medium
skill_id: weekly-agency-review
...
evidence_sources:
  - "Zimmerman (2000) — Attaining self-regulation:
    forethought-performance-reflection cycle"
  - "Hattie (2009) — Visible Learning: metacognitive strategies (d ≈ 0.69)"
  - Sitzmann & Ely (2011) — A meta-analysis of self-regulated learning in
    work-related training (d = 0.62)
  - "Winne et al. (2019) — Learning analytics for self-regulated learning:
    theory and empirical practice"
  - Azevedo et al. (2013) — Using trace methodology and sequential analysis to
    understand SRL processes
input_schema:
  required:
    - field: review_period
      type: string
  ...
  optional:
    - field: session_data
      type: array
      description: "Structured evidence from prior sessions: confidence ratings, hint
        levels, retrieval quality, unassisted check results, transfer check
        results"
