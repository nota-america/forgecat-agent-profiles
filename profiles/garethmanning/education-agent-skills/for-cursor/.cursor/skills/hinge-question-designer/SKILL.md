...
description: Design a diagnostic hinge question that reveals whether students
  understand enough to move on. Use when planning key checkpoints mid-lesson
  during explicit or direct instruction.
disable-model-invocation: false
user-invocable: true
effort: medium
skill_id: hinge-question-designer
skill_name: Hinge Question Designer
domain: questioning-discussion
version: "1.0"
evidence_strength: strong
evidence_sources:
  - "Wiliam (2011) — Embedded Formative Assessment: hinge questions as real-time
    diagnostic tools"
  - Christodoulou (2017) — Making Good Progress? The future of Assessment for
    Learning
...
input_schema:
  required:
    ...
    - field: lesson_context
      type: string
      description: What has been taught so far in this lesson — the hinge question
        checks whether students understood this before moving on
  optional:
    ...
    - field: response_method
      type: string
      description: How students will respond — e.g. mini-whiteboards, fingers
        (A/B/C/D), clickers, hands up
    - field: time_constraint
      type: string
      description: Maximum time for students to answer — hinge questions should be
...
output_schema:
  ...
  fields:
    ...
    - field: decision_guide
      type: string
      description: What to do based on class response patterns — when to proceed,
        re-teach, or differentiate
