...
description: Map curriculum connections across multiple subjects for a
  real-world problem or authentic context. Use when planning cross-curricular
  projects or connecting content to real issues.
disable-model-invocation: false
user-invocable: true
effort: medium
skill_id: interdisciplinary-real-world-connection-mapper
...
evidence_sources:
  ...
  - "Beane (1997) — Curriculum Integration: designing the core of democratic
    education"
  - Rennie, Venville & Wallace (2012) — Integrating Science, Technology,
    Engineering, and Mathematics
  - Czerniak, Weber, Sandmann & Ahern (1999) — Literature review of science and
...
input_schema:
  required:
    ...
    - field: primary_subject
      type: string
      description: The teacher's own subject — the discipline from which this
...
output_schema:
  ...
  fields:
    ...
    - field: implementation_plan
      type: object
      description: How to implement — from single-teacher connections to full
