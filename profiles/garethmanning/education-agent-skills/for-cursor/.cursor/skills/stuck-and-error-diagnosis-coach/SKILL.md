...
description: When a learner gets something wrong or feels stuck, require them to
  diagnose the problem before receiving help. Ensures help targets the actual
  cognitive breakdown, not just the surface error.
disable-model-invocation: false
user-invocable: true
effort: medium
skill_id: stuck-and-error-diagnosis-coach
...
evidence_sources:
  ...
  - "Hattie & Timperley (2007) — The power of feedback: process and
...
input_schema:
  required:
    - field: stuck_point_or_error
      type: string
      description: What the student got wrong or where they are stuck — their
        attempted work or description of the block
    - field: context
      type: string
