...
description: Select evidence-based study strategies matched to material type,
  learning goal, and student habits. Use when advising students on revision
  techniques, homework, or independent study approaches.
disable-model-invocation: false
user-invocable: true
effort: medium
skill_id: study-strategy-selector
...
evidence_sources:
  - "Dunlosky et al. (2013) — Improving students' learning with effective
    ...
    psychology"
  - "Roediger & Pyc (2012) — Inexpensive techniques to improve education:
  ...
  - "Hartwig & Dunlosky (2012) — Study strategies of college students: are
    self-testing and scheduling related to achievement?"
  - "Miyatsu et al. (2018) — Five popular study strategies: their pitfalls and
...
output_schema:
  ...
  fields:
    - field: recommended_strategies
      type: array
      description: Ranked list of strategies with evidence rating, implementation
        guide, and time allocation
