...
description: Design a variation theory task using contrast, separation, and
  fusion to teach critical features of a concept. Use when students confuse
  similar concepts or fail to discern key distinctions.
disable-model-invocation: false
user-invocable: true
effort: medium
skill_id: variation-theory-task-designer
...
evidence_sources:
  ...
  - Kullberg, Runesson Kempe & Marton (2017) — What is made possible to learn
    when using the variation theory of learning in teaching mathematics?
  - "Gu, Huang & Marton (2004) — Teaching with variation: a Chinese way of
    promoting effective Mathematics learning"
input_schema:
  required:
  ...
  optional:
    ...
    - field: current_task
      type: string
      description: The existing task or activity that could be redesigned using
        variation theory
...
output_schema:
  ...
  fields:
    ...
    - field: teacher_guidance
      type: object
      description: How to present the variation — what to draw attention to, what
        questions to ask
