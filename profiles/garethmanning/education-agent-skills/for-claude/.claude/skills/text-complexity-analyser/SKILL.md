...
description: Analyse text complexity across quantitative, qualitative, and
  reader-task dimensions with scaffolding recommendations. Use when selecting
  texts, assessing readability, or planning reading support.
disable-model-invocation: false
user-invocable: true
effort: medium
skill_id: text-complexity-analyser
...
evidence_sources:
  ...
  - "Hiebert (2012) — Seven actions that teachers can take right now: text
    complexity"
  ...
  - "Graves & Graves (2003) — Scaffolding Reading Experiences: designs for
    student success"
input_schema:
  required:
    - field: text_description
      type: string
      description: A description of the text including genre, topic, approximate
        length, and source
    - field: student_level
      type: string
...
output_schema:
  ...
  fields:
    ...
    - field: scaffold_plan
      type: object
      description: Before, during, and after reading scaffolds tailored to the
