...
description: Design a lesson that embeds PERMA wellbeing elements alongside
  academic learning objectives. Use when planning lessons that intentionally
  support both content mastery and student flourishing.
disable-model-invocation: false
user-invocable: true
effort: medium
skill_id: perma-based-lesson-designer
skill_name: PERMA-Based Lesson Designer
domain: wellbeing-motivation-agency
version: "1.0"
evidence_strength: moderate
evidence_sources:
  - "Seligman (2011) — Flourish: a visionary new understanding of happiness and
    well-being"
  - "Kern et al. (2015) — A multidimensional approach to measuring well-being in
    students: EPOCH"
  - Norrish et al. (2013) — An applied framework for Positive Education at
    Geelong Grammar School
  - "White & Kern (2018) — Positive Education: learning and teaching for
    wellbeing and academic mastery"
...
output_schema:
  ...
  fields:
    - field: perma_lesson_plan
      type: object
      description: A lesson plan that integrates PERMA elements into the academic
        content — not separate wellbeing activities but wellbeing through
        learning
    - field: perma_mapping
      type: object
