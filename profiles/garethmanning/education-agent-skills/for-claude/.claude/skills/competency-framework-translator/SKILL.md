...
description: Translate an external competency framework like DigComp, GreenComp,
  or ISTE into classroom-ready activities. Use when implementing framework
  standards in specific teaching contexts.
disable-model-invocation: false
user-invocable: true
effort: medium
skill_id: competency-framework-translator
skill_name: Competency Framework Translator
domain: professional-learning
version: "1.0"
evidence_strength: moderate
evidence_sources:
  - "Wiggins & McTighe (2005) — Understanding by Design: translating standards
    into classroom practice"
  - "Marzano & Kendall (2007) — The New Taxonomy of Educational Objectives:
    operationalising competencies"
  - "European Commission (2022) — DigComp 2.2: the Digital Competence Framework
    for Citizens"
  - "Bianchi, Pisiotis & Cabrera (2022) — GreenComp: the European sustainability
...
input_schema:
  required:
    - field: framework_reference
      type: string
      description: The external competency framework to translate — name, specific
        competency area, and level/descriptor to work with
  ...
  optional:
    ...
    - field: integration_approach
      type: string
      description: Whether the competency will be taught standalone, embedded in
        subject content, or assessed as a cross-curricular outcome
    - field: assessment_needs
      type: string
      description: How the teacher needs to assess the competency — formative,
        summative, portfolio, observation
output_schema:
  type: object
  fields:
    - field: translated_competency
      type: object
      description: The competency rewritten as specific, observable indicators
    ...
    - field: assessment_criteria
      type: object
      description: How to assess whether a student has developed the competency —
        observable indicators at each level
chains_well_with:
  - competency-unpacker
