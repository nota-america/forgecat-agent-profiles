...
description: Design a mastery experience sequence that systematically builds
  student confidence in a skill they avoid. Use when students say 'I can't do
  this', avoid tasks, or show learned helplessness.
disable-model-invocation: false
user-invocable: true
effort: medium
skill_id: self-efficacy-builder-sequence
skill_name: Self-Efficacy Builder Sequence
domain: wellbeing-motivation-agency
version: "1.0"
evidence_strength: strong
evidence_sources:
  - "Bandura (1977, 1997) — Self-efficacy: toward a unifying theory of
    behavioural change"
  - "Bandura (1986) — Social Foundations of Thought and Action: four sources of
    self-efficacy"
  - Schunk & Pajares (2009) — Self-efficacy theory in educational contexts
  - "Hattie (2009) — Visible Learning: self-efficacy as one of the strongest
...
output_schema:
  ...
  fields:
    ...
    - field: teacher_scripts
      type: array
      description: Exact phrases the teacher can use at each stage to reinforce
        self-efficacy
chains_well_with:
