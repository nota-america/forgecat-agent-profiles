...
description: Tier vocabulary from a text or topic into everyday, academic, and
  technical categories with teaching priorities. Use when pre-teaching
  vocabulary or identifying language barriers in a text.
disable-model-invocation: false
user-invocable: true
effort: medium
skill_id: vocabulary-tiering-tool
skill_name: Vocabulary Tiering Tool
domain: eal-language-development
version: "1.0"
evidence_strength: strong
evidence_sources:
  - "Beck, McKeown & Kucan (2002, 2013) — Bringing Words to Life: robust
...
output_schema:
  ...
  fields:
    ...
    - field: word_teaching_cards
      type: array
      description: "For each priority word: definition, example in context, visual
        cue, common confusions"
    - field: quick_check
      type: string
