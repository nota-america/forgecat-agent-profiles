...
description: Anchor a multidisciplinary unit in a real-world phenomenon that
  requires multiple subject lenses to understand. Use when designing integrated
  or phenomenon-based units across disciplines.
disable-model-invocation: false
user-invocable: true
effort: medium
skill_id: phenomenon-based-unit-anchor
skill_name: Phenomenon-Based Unit Anchor
domain: global-cross-cultural-pedagogies
version: "1.0"
evidence_strength: moderate
evidence_sources:
  - Finnish National Agency for Education (2016) — National Core Curriculum for
    Basic Education (POPS 2016)
  - Lonka (2018) — Phenomenal Learning from Finland
  - Symeonidis & Schwarz (2016) — Phenomenon-based teaching and learning through
    the pedagogical lenses of phenomenology
...
input_schema:
  required:
    - field: phenomenon
      type: string
      description: The real-world phenomenon that anchors the unit — a complex,
        authentic situation that requires multiple subject lenses to understand
...
output_schema:
  ...
  fields:
    - field: unit_design
      type: object
      description: The complete phenomenon-based unit — anchor phenomenon, driving
        questions, subject contributions, integration points
    ...
    - field: assessment_design
      type: object
      description: How to assess understanding of the phenomenon — demonstrating
        integrated understanding, not subject-by-subject testing
chains_well_with:
