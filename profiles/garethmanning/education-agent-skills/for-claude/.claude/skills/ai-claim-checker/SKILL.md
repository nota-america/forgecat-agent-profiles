...
description: After any AI-generated explanation, require the learner to identify
  one place it could be wrong, one thing to check, and one source to consult.
  Builds epistemic vigilance — treats AI output as a claim to evaluate, not
  truth to absorb.
disable-model-invocation: false
user-invocable: true
effort: light
skill_id: ai-claim-checker
...
input_schema:
  required:
    - field: ai_generated_content
      type: string
      description: The AI-generated explanation, claim, or answer that the learner
        should evaluate
    - field: topic
      type: string
  ...
  optional:
    - field: subject_area
      type: string
      description: Academic subject — helps calibrate what verification sources are
        appropriate
