...
description: Build a complete explicit instruction sequence from teacher
  modelling through guided practice to independent work. Use when teaching new
  skills, procedures, or concepts through direct instruction.
disable-model-invocation: false
user-invocable: true
effort: medium
skill_id: explicit-instruction-sequence-builder
...
evidence_sources:
  ...
  - "Archer & Hughes (2011) — Explicit Instruction: Effective and Efficient
    Teaching"
  - "Hattie (2009) — Visible Learning: direct instruction effect size 0.59"
  - "Engelmann & Carnine (1982) — Theory of Instruction: principles and
    applications"
input_schema:
  required:
