...
description: Design a moment of awe or wonder that hooks curiosity and deepens
  emotional engagement with content. Use when opening units, introducing
  surprising material, or reigniting student interest.
disable-model-invocation: false
user-invocable: true
effort: medium
skill_id: awe-wonder-experience-designer
skill_name: Awe & Wonder Experience Designer
domain: wellbeing-motivation-agency
version: "1.0"
evidence_strength: emerging
evidence_sources:
  - Keltner & Haidt (2003) — Approaching awe, a moral, spiritual, and aesthetic
    emotion
  - "Keltner (2023) — Awe: the new science of everyday wonder and how it can
    transform your life"
  - Valdesolo & Graham (2014) — Awe, uncertainty, and agency detection
  - "Shiota, Keltner & Mossman (2007) — The nature of awe: elicitors,
    appraisals, and effects on self-concept"
...
output_schema:
  ...
  fields:
    ...
    - field: vastness_element
      type: string
      description: What creates the sense of vastness — physical, temporal,
        conceptual, or social
