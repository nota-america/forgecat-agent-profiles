...
description: Require the learner to explain a concept in their own words before
  the AI evaluates or extends it. Ensures the AI works from the learner's
  understanding rather than providing an explanation from scratch.
disable-model-invocation: false
user-invocable: true
effort: medium
skill_id: explain-first-interrogator
...
evidence_sources:
  ...
  - "Bisra et al. (2018) — Inducing self-explanation: a meta-analysis (64
    reports, g = 0.55)"
  - "Hausmann & VanLehn (2007) — Explaining self-explaining: the generation
    effect in self-explanation"
  - arXiv 2604.00142 (2026) — LLM-supported self-explanation improving transfer
    performance
input_schema:
  required:
