...
description: Create self-explanation prompts that deepen understanding of worked
  examples, texts, or diagrams. Use when students read material passively
  without engaging with underlying principles.
disable-model-invocation: false
user-invocable: true
effort: medium
skill_id: self-explanation-prompt-designer
...
evidence_sources:
  ...
  - "Hausmann & VanLehn (2007) — Explaining self-explaining: a contrast between
    content and generation"
  - Wylie & Chi (2014) — The self-explanation principle in multimedia learning
  - "Rittle-Johnson (2006) — Promoting transfer: effects of self-explanation and
    direct instruction"
input_schema:
  required:
    - field: learning_material
      ...
      description: The specific content students are studying — a worked example, a
        text passage, a diagram, or a demonstration that students need to deeply
        understand
    - field: target_understanding
      type: string
      description: What students should understand DEEPLY after engaging with this
        material — the conceptual insight, not just the surface content
  optional:
    - field: student_level
      type: string
    ...
    - field: delivery_mode
      ...
      description: How the self-explanation prompts will be delivered — embedded in
        text, AI-generated during study, teacher-led, or integrated in a
        tutoring system
...
output_schema:
  ...
  fields:
    - field: self_explanation_prompts
      type: array
      description: The specific prompts placed at key points in the material — what to
        ask and where to ask it
