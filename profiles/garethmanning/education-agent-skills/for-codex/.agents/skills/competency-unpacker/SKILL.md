...
description: Unpack a broad standard or competency descriptor into specific,
  assessable success criteria and sub-skills. Use when interpreting curriculum
  standards or writing learning objectives.
disable-model-invocation: false
user-invocable: true
effort: medium
skill_id: competency-unpacker
skill_name: Competency Unpacker
domain: curriculum-assessment
version: "1.0"
evidence_strength: strong
evidence_sources:
  - "Wiggins & McTighe (1998, 2005) — Understanding by Design: backward design
...
output_schema:
  ...
  fields:
    ...
    - field: success_criteria
      type: object
      description: Success criteria at multiple levels — beginning, developing,
        secure, extending
chains_well_with:
