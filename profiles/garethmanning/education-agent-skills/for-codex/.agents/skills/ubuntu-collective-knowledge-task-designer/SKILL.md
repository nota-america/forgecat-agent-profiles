...
description: Design learning tasks built on Ubuntu philosophy emphasising
  collective knowledge-building and mutual responsibility. Use when fostering
  collaboration that values community over individual competition.
disable-model-invocation: false
user-invocable: true
effort: medium
skill_id: ubuntu-collective-knowledge-task-designer
skill_name: Ubuntu Collective Knowledge Task Designer
domain: global-cross-cultural-pedagogies
version: "1.0"
evidence_strength: emerging
evidence_sources:
  - Mkabela (2005) — Using the Afrocentric method in researching indigenous
    African culture
...
input_schema:
  required:
    ...
    - field: class_context
      type: string
      description: The class composition, community context, and how students
        currently relate to collaborative learning
  optional:
    - field: subject_area
      type: string
...
output_schema:
  ...
  fields:
    ...
    - field: individual_within_collective
      type: object
      description: How individual growth and accountability exist within the
        collective structure — not erased but reframed
chains_well_with:
