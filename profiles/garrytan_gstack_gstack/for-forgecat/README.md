...
```bash
cd ~/.claude/skills/garrytan-gstack && ./setup --team
```
...
```bash
cd <your-repo>
~/.claude/skills/garrytan-gstack/bin/gstack-team-init required  # or: optional
...
> ```bash
> git clone https://github.com/garrytan/gstack.git ~/.claude/skills/garrytan-gstack
> ```
...
See the [original gstack README](https://github.com/garrytan/gstack#uninstall) for manual uninstall steps.
