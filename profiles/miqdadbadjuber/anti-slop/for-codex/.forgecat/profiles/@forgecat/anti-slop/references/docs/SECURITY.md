...
- is written only after you approve. The installer and the manual wizard both ask first.
...
- lives in [cli/lib/install.mjs](https://github.com/miqdadbadjuber/anti-slop/blob/3c6cdd7f0dc5423e02b9a0bf70a3d9f1c0da644a/cli/lib/install.mjs) for the installer, and in the wizard inside [antislop.md](https://github.com/miqdadbadjuber/anti-slop/blob/3c6cdd7f0dc5423e02b9a0bf70a3d9f1c0da644a/antislop.md) for the manual path.
...
- ships as a local file inside the skill folder, [skills/antislop-human/contrast-check.py](https://github.com/miqdadbadjuber/anti-slop/blob/3c6cdd7f0dc5423e02b9a0bf70a3d9f1c0da644a/skills/antislop-human/contrast-check.py). You fetch it; the agent never downloads anything from the network.
