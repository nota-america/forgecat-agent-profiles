...
COMPONENTS_TARBALL="$(cd "$(dirname ".forgecat/profiles/@forgecat/anthropics_skills_web-artifacts-builder/assets/web-artifacts-builder/scripts/shadcn-components.tar.gz")" && pwd)/shadcn-components.tar.gz"
