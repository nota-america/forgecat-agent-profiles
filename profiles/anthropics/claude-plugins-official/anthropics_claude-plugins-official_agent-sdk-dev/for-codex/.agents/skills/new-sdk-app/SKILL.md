...
metadata:
  ...
  forgecat-source-command: commands/new-sdk-app.md
  forgecat-source-sha256: sha256-483057d3d8192000006b5e7634b444a9c5ad368cb23637eaa3631bc0b0557d08
---

# Invocation of new-sdk-app

This is the Codex skill form of /new-sdk-app. Invoke it explicitly as $new-sdk-app.
In the preserved instructions below, $ARGUMENTS means the text the user supplied with this invocation. It is not an environment variable or an automatic shell expansion. If no arguments were supplied, treat it as absent and follow the source questions. Preserve the source question order and approval gates. When instructed to launch a named verifier, use that installed Codex agent in a separate context; do not replace it with main-thread self-verification. If delegation is unavailable, report the limitation.

When the source names WebFetch or WebSearch, use the available Codex web page reading or search capability for the same task. If unavailable, report it; do not pretend current documentation or package versions were checked.
