...
2. If not, copy it from `.forgecat/profiles/@forgecat/anthropics_knowledge-work-plugins_productivity/skills/dashboard.html` to the current working directory
