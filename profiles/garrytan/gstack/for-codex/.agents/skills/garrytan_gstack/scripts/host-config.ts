...
export interface HostConfig {
  ...
  // --- Path Configuration ---
  /** Global install path relative to $HOME (e.g., '.config/opencode/skills/garrytan_gstack'). */
  globalRoot: string;
  /** Project-local skill path relative to repo root (e.g., '.opencode/skills/garrytan_gstack'). */
  ...
  /** Optional repo-local sidecar config (e.g., Codex uses .agents/skills/garrytan_gstack). */
  sidecar?: {
    /** Sidecar path relative to repo root (e.g., '.agents/skills/garrytan_gstack'). */
    path: string;
