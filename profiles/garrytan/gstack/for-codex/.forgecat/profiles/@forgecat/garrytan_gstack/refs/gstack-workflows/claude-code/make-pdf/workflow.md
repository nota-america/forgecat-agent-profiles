...
[ -z "$P" ] && [ -n "$_ROOT" ] && [ -x "$_ROOT/$GSTACK_ROOT/make-pdf/dist/pdf" ] && P="$_ROOT/$GSTACK_ROOT/make-pdf/dist/pdf"
...
```bash
$GSTACK_ROOT/bin/gstack-skill-end --skill "make-pdf" --outcome OUTCOME \
