...
eval "$($GSTACK_ROOT/bin/gstack-slug 2>/dev/null)" 2>/dev/null || true
  $GSTACK_ROOT/bin/gstack-brain-cache invalidate product --project "$SLUG" 2>/dev/null || true
  $GSTACK_ROOT/bin/gstack-brain-cache invalidate goals --project "$SLUG" 2>/dev/null || true
  $GSTACK_ROOT/bin/gstack-brain-cache invalidate competitive-intel --project "$SLUG" 2>/dev/null || true
```
