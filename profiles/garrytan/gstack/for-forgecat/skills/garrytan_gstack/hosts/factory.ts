...
const factory: HostConfig = {
  ...
  globalRoot: '.factory/skills/garrytan_gstack',
  localSkillRoot: '.factory/skills/garrytan_gstack',
  hostSubdir: '.factory',
  usesEnvVars: true,
  ...
  pathRewrites: [
    ...
    { from: '$GSTACK_ROOT', to: '.factory/skills/garrytan_gstack' },
    { from: '.claude/skills/review', to: '.factory/skills/garrytan_gstack/review' },
