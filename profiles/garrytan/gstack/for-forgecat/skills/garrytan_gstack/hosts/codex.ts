...
const codex: HostConfig = {
  ...
  globalRoot: '.codex/skills/garrytan_gstack',
  localSkillRoot: '.agents/skills/garrytan_gstack',
  hostSubdir: '.agents',
  usesEnvVars: true,
  ...
  pathRewrites: [
    ...
    { from: '$GSTACK_ROOT', to: '.agents/skills/garrytan_gstack' },
    { from: '.claude/skills/review', to: '.agents/skills/garrytan_gstack/review' },
  ...
  sidecar: {
    path: '.agents/skills/garrytan_gstack',
