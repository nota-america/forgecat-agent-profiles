...
Analyze the plan's implementation steps for parallel execution opportunities. This helps the user split work across git worktrees (via Claude Code's delegate_task with `isolation: "worktree"` or parallel workspaces).
