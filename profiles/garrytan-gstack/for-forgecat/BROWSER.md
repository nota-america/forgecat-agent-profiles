...
4. **Navigate to the extension folder:** Press **Cmd+Shift+G** in the file picker to open "Go to folder", then paste one of these paths:
   - Global install: `~/.claude/skills/garrytan-gstack/extension`
...
1. Push your branch
2. Pull in the skill directory: `cd ~/.claude/skills/garrytan-gstack && git pull`
3. Rebuild: `cd ~/.claude/skills/garrytan-gstack && bun run build`

Or copy the binary directly: `cp browse/dist/browse ~/.claude/skills/garrytan-gstack/browse/dist/browse`
