...
- [scripts/get-pr-comments.sh](scripts/get-pr-comments.sh) -- GraphQL query for unresolved review threads
- [scripts/get-thread-for-comment.sh](scripts/get-thread-for-comment.sh) -- Map a comment node ID to its parent thread (for targeted mode)
- [scripts/reply-to-pr-thread.sh](scripts/reply-to-pr-thread.sh) -- GraphQL mutation to reply within a review thread
- [scripts/resolve-pr-thread.sh](scripts/resolve-pr-thread.sh) -- GraphQL mutation to resolve a thread by ID
