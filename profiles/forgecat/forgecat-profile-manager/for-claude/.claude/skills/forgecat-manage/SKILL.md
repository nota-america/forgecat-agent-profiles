...
description: Inspect, update, replace and remove installed ForgeCat profiles.
  Use when the user asks what's installed, sees modified files, wants to upgrade
  or roll back a profile, run two profiles side by side, or configure MCP env
  vars.
---
