...
description: Find, evaluate and install a ForgeCat profile. Use when the user
  wants to browse the registry, compare profiles, install one into a project or
  a home-target agent, or when an install is refused.
---
