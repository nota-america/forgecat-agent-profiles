---
name: eng-tech-lead
description: Central engineering coordinator that routes broad engineering requests, standups, technical documentation, and cross-functional work to the right specialist agent or underlying engineering skill.
model: inherit
skills:
  - standup
  - documentation
