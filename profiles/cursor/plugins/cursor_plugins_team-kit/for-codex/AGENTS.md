<!-- forgecat:@forgecat/cursor_plugins_team-kit:no-inline-imports.mdc:start -->
# No inline imports
...
<!-- forgecat:@forgecat/cursor_plugins_team-kit:no-inline-imports.mdc:end -->

<!-- forgecat:@forgecat/cursor_plugins_team-kit:typescript-exhaustive-switch.mdc:start -->
...
<!-- forgecat:@forgecat/cursor_plugins_team-kit:typescript-exhaustive-switch.mdc:end -->
