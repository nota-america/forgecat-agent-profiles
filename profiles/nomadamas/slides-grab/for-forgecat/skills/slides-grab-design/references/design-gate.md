...
- [ ] Every color traces back to the approved style spec (`{{ref:designStyles}}`) / the user's brand tokens, or a documented harmonic `oklch()` extension of them.
