...
## Chart guidance
- Use Chart.js as the default charting library for quantitative slides; `{{ref:templates}}/chart.html` is the packaged starting point.
...
- `{{ref:templates}}/cover.html`
- `{{ref:templates}}/contents.html`
- `{{ref:templates}}/section-divider.html`
- `{{ref:templates}}/content.html`
- `{{ref:templates}}/statistics.html`
- `{{ref:templates}}/split-layout.html`
- `{{ref:templates}}/team.html`
- `{{ref:templates}}/quote.html`
- `{{ref:templates}}/timeline.html`
- `{{ref:templates}}/closing.html`
- `{{ref:templates}}/chart.html`
- `{{ref:templates}}/diagram.html`
- `{{ref:templates}}/diagram-tldraw.html`
- `{{ref:templates}}/custom/`
- `{{ref:templates}}/design-styles/README.md` — bundled design collection reference derived from `corazzon/pptx-design-styles` and `epoko77-ai/design-diversity`
- `{{ref:templates}}/design-styles/preview.html` — visual gallery of all 95 styles (open with `slides-grab preview-styles`)
- `{{ref:designStyles}}` and `{{ref:designDiversity}}` — full style specs (colors, fonts, layout, signature elements, things to avoid) for all 95 bundled styles; read these after the user picks a style to ground your design tokens
