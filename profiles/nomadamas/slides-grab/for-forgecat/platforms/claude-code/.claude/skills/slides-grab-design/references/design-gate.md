...
- [ ] Every color traces back to the approved style spec (`.forgecat/profiles/@forgecat/nomadamas_slides-grab/src/design-styles-data.json`) / the user's brand tokens, or a documented harmonic `oklch()` extension of them.
