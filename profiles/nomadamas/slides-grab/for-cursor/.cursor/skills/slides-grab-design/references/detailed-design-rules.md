...
## Color Usage Rules
- Pull every color from the approved style spec in `.forgecat/profiles/@forgecat/nomadamas_slides-grab/src/design-styles-data.js` or the user-provided brand tokens. Do not invent fresh standalone hex colors mid-slide.
