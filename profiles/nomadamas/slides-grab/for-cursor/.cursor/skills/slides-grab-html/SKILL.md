...
1. Read approved `slide-outline.md`, load the style spec (`.forgecat/profiles/@forgecat/nomadamas_slides-grab/src/design-styles-data.json` for bundled ids, `slides-grab show-design` for `DESIGN.slides.md`, or `.slides-grab/template-pack.json` for imported packs).
