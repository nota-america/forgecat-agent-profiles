...
The forgecat profile installs the seven portable skills, templates, and style data. The npm package provides the `slides-grab` commands that render, validate, edit, and export decks.
