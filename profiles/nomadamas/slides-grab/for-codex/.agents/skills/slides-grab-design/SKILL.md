...
2. Load the chosen style's full spec:
   - If `style` is a bundled id (e.g. `glassmorphism`), load from `.forgecat/profiles/@forgecat/nomadamas_slides-grab/src/design-styles-data.js` — colors, fonts, layout, signature elements, and things to avoid.
