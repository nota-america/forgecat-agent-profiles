...
Use [demo/index.html](demo/index.html) as the working reference and [demo/PROMPT.md](demo/PROMPT.md) to recreate or remix it. Inspect the rendered preview at `{{ref:webDesignPreviews}}/scroll-scrubbed-word-reveal/preview.jpg`. Keep [REFERENCES.md](REFERENCES.md) as the links-only implementation source list.
