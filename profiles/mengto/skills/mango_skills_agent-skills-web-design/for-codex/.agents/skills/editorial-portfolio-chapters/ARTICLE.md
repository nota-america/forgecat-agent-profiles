...
![Signal acquisition loader with a frequency readout](.forgecat/profiles/@forgecat/mango_skills_agent-skills-web-design/assets/editorial-portfolio-chapters/mara-voss-01-signal-loader.png)

![Resolved editorial hero after the loader](.forgecat/profiles/@forgecat/mango_skills_agent-skills-web-design/assets/editorial-portfolio-chapters/mara-voss-02-decoded-hero.png)
...
![Paper hero splitting apart to reveal the dark biography chapter](.forgecat/profiles/@forgecat/mango_skills_agent-skills-web-design/assets/editorial-portfolio-chapters/mara-voss-03-split-door-handoff.png)
...
![Pinned biography with the current reading words illuminated](.forgecat/profiles/@forgecat/mango_skills_agent-skills-web-design/assets/editorial-portfolio-chapters/mara-voss-04-pinned-bio-illumination.png)
...
![Pinned archive marquee and recording player](.forgecat/profiles/@forgecat/mango_skills_agent-skills-web-design/assets/editorial-portfolio-chapters/mara-voss-05-archive-playhead-player.png)
...
![Dark chapter panel with a timestamped line reveal](.forgecat/profiles/@forgecat/mango_skills_agent-skills-web-design/assets/editorial-portfolio-chapters/mara-voss-06-chapter-wipe-ledger.png)
...
![Asymmetric archive metrics resolving in staggered beats](.forgecat/profiles/@forgecat/mango_skills_agent-skills-web-design/assets/editorial-portfolio-chapters/mara-voss-07-pinned-counter-index.png)
...
![A new recording plate stacking over the previous one](.forgecat/profiles/@forgecat/mango_skills_agent-skills-web-design/assets/editorial-portfolio-chapters/mara-voss-08-sticky-recording-stack.png)
...
![Catalogue card isolated by a moving inspection light](.forgecat/profiles/@forgecat/mango_skills_agent-skills-web-design/assets/editorial-portfolio-chapters/mara-voss-09-inspection-light-table.png)
...
![Opposing image plates assembled around a final statement](.forgecat/profiles/@forgecat/mango_skills_agent-skills-web-design/assets/editorial-portfolio-chapters/mara-voss-10-final-entry-dissolve.png)
...
![Dark recording image resolving from blur](.forgecat/profiles/@forgecat/mango_skills_agent-skills-web-design/assets/editorial-portfolio-chapters/mara-voss-11-silence-dark-room.png)
...
![Field-log record in focus while surrounding entries recede](.forgecat/profiles/@forgecat/mango_skills_agent-skills-web-design/assets/editorial-portfolio-chapters/mara-voss-12-field-log-reveal.png)
...
![Footer CTA with magnetic offset and completed scroll progress](.forgecat/profiles/@forgecat/mango_skills_agent-skills-web-design/assets/editorial-portfolio-chapters/mara-voss-13-magnetic-footer-utilities.png)
