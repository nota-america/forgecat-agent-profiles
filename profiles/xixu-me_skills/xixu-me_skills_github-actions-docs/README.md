...
```bash
npx forgecat install @forgecat/xixu-me_skills_github-actions-docs
```
...
|---|---|
| Author | Xi Xu |
| Original repository | https://github.com/xixu-me/skills/tree/main/skills/github-actions-docs |
| Version | `0.1.0` |
