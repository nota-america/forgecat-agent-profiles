...
```bash
npx forgecat install @forgecat/xixu-me_skills_opensource-guide-coach
```
...
|---|---|
| Author | Xi Xu |
| Original repository | https://github.com/xixu-me/skills/tree/main/skills/opensource-guide-coach |
| Version | `0.1.0` |
