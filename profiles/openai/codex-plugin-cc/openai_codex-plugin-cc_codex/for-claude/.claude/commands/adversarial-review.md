...
- Run:
```bash
node ".forgecat/profiles/@forgecat/openai_codex-plugin-cc_codex/scripts/codex-companion.mjs" adversarial-review "$ARGUMENTS"
```
...
```typescript
Bash({
  command: `node ".forgecat/profiles/@forgecat/openai_codex-plugin-cc_codex/scripts/codex-companion.mjs" adversarial-review "$ARGUMENTS"`,
