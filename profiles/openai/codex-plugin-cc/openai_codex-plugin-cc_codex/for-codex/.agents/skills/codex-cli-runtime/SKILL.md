...
description: Internal helper contract for calling the codex-companion runtime
  from Claude Code
...
Primary helper:
- `node ".forgecat/profiles/@forgecat/openai_codex-plugin-cc_codex/scripts/codex-companion.mjs" task "<raw arguments>"`
