...
[![Profiles](https://img.shields.io/badge/profiles-183-blue)](#browse-profiles)
...
| [forgecat/forgecat-agent-profiles](./profiles/forgecat/forgecat-agent-profiles) | 2 | ForgeCat-authored orchestration profiles built from existing profile packages |
...
Total: 183 profiles across 36 collections.
