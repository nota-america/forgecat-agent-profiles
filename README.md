...
| [anthropics-claude-plugins-official](./profiles/anthropics-claude-plugins-official) | 7 | Hook-free official Anthropic Claude plugin conversions (skills, agents, commands, MCP) |
