...
| [anthropics-claude-plugins-official](./profiles/anthropics-claude-plugins-official) | 21 | Official Anthropic Claude plugin conversions (skills, agents, commands, hooks, MCP) |
