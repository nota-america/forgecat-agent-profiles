...
| [forgecat/forgecat-profile-manager](./profiles/forgecat/forgecat-profile-manager) | 1 | Browse, install, manage, author, and publish ForgeCat profiles from the CLI |
