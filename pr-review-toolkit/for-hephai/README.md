...
Comprehensive collection of specialized agents for thorough pull request review. Each agent focuses on a specific aspect of code quality: comments, tests, error handling, type design, code quality, and simplification.

## Agents

- **code-reviewer**: Review code for project guidelines compliance and best practices
- **code-simplifier**: Simplify code while preserving functionality
- **comment-analyzer**: Analyze code comments for accuracy and maintainability
- **pr-test-analyzer**: Review test coverage quality and completeness
- **silent-failure-hunter**: Identify silent failures and inadequate error handling
- **type-design-analyzer**: Analyze type design and invariant expression

## Commands

- **review-pr**: Comprehensive PR review using all specialized agents

Use agents individually for targeted review or together for comprehensive PR analysis.
